...
from cc_code.tui.input_handler import _handle_input
    ...
    env.update(
        {
            ...
            "CC_CODE_MODEL": "gpt-4o",
            "CC_CODE_MODEL_MODE": "mock",
            "CC_CODE_TOOL_PROFILE": "core",
            "CC_CODE_SHOW_GUIDE": "0",
...
def test_release_cli_valid_config_runs_as_black_box(tmp_path: Path) -> None:
    ...
    completed = subprocess.run(
        [sys.executable, "-m", "cc_code.main", "valid-config"],
        cwd=workspace,
...
def test_release_non_tty_main_handles_memory_and_local_commands(tmp_path: Path) -> None:
    ...
    memory_file = workspace / ".cc-code-memory" / "MEMORY.md"
