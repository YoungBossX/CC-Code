...
from cc_code.agent_metrics import (
...
from cc_code.agent_intelligence import (
    ClassifiedError,
...
from cc_code.memory_injector import InjectedMemory, MemoryInjector
from cc_code.memory import MemoryManager, MemoryScope
from cc_code.tooling import ToolCapability, ToolDefinition, ToolMetadata, ToolRegistry
...
class TestAgentLoopIntegration:
    ...
    def test_error_recovery_integration(self):
        ...
        from cc_code.agent_loop import run_agent_turn
        from cc_code.types import AgentStep, ToolCall
