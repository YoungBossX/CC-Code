...
import cc_code.tools.test_runner as test_runner_module
import cc_code.tools.run_command as run_command_module
from cc_code.permissions import PermissionManager
from cc_code.tools.batch_ops import batch_copy_tool, batch_move_tool
from cc_code.tools.code_nav import find_references_tool, find_symbols_tool, get_ast_info_tool
from cc_code.tools.code_review import code_review_tool
from cc_code.tools.file_tree import file_tree_tool
from cc_code.tools.run_command import _build_execution_command, split_command_line
from cc_code.tools.patch_file import patch_file_tool
from cc_code.tools.archive_utils import tar_extract_tool, zip_extract_tool
...
def test_core_tool_registry_does_not_import_utility_modules(tmp_path: Path) -> None:
    utility_modules = [
        "cc_code.tools.archive_utils",
        "cc_code.tools.crypto_utils",
        "cc_code.tools.csv_utils",
        "cc_code.tools.encoding_utils",
        "cc_code.tools.http_utils",
        "cc_code.tools.json_utils",
        "cc_code.tools.regex_utils",
        "cc_code.tools.text_utils",
    ]
