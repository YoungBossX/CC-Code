...
from cc_code.skills import discover_skills, load_skill


def test_discover_skills_prefers_project_root(tmp_path: Path, monkeypatch) -> None:
    project_skill = tmp_path / ".cc-code" / "skills" / "demo" / "SKILL.md"
    ...
    user_skill = user_home / ".cc-code" / "skills" / "demo" / "SKILL.md"
