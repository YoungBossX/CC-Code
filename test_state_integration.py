...
from cc_code.state import create_app_store, AppState, increment_tool_calls, add_cost, set_busy, set_idle
from cc_code.state_integration import get_global_store, set_global_store, track_api_call, track_tool_call, track_tool_completion
...
def test_tracking_functions():
    ...
    # Reset global store
    from cc_code.state_integration import reset_state
    reset_state()
...
def test_state_summary():
    ...
    from cc_code.state_integration import get_state_summary, get_cost_summary, reset_state
