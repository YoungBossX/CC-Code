"""Unified model registry and routing for CC-Coder.
...
from cc_code.types import AgentStep
...
def build_provider_config(model: str, runtime: dict | None = None) -> ProviderConfig:
    ...
    if provider == Provider.OPENROUTER:
        return ProviderConfig(
            ...
            extra_headers={
                "HTTP-Referer": os.environ.get("OPENROUTER_REFERER", "https://github.com/cc_code-py"),
                "X-Title": os.environ.get("OPENROUTER_TITLE", "CC-Coder Python"),
            },
            extra_params={
...
def create_model_adapter(
    ...
    """
    if force_mock or os.environ.get("CC_CODE_MODEL_MODE") == "mock":
    ...
    if provider_config.is_openai_compatible:
        from cc_code.openai_adapter import OpenAIModelAdapter
