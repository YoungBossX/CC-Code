...
from cc_code.memory import MemoryManager, MemoryScope, MemoryEntry
...
class MemoryInjector:
    ...
    def __init__(
        ...
        self._injection_cooldown: float = injection_cooldown  # Seconds between injections
