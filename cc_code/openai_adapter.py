"""OpenAI-compatible API adapter for CC-Coder.
...
from cc_code.api_retry import RETRYABLE_STATUS, calculate_backoff
from cc_code.cost_tracker import calculate_cost
from cc_code.state import Store, AppState, add_cost, record_api_error, update_context_usage
from cc_code.types import AgentStep, StepDiagnostics
    ...
    def next(
        ...
        if store:
            ...
            if stream_input_tokens == 0:
                from cc_code.context_manager import estimate_messages_tokens
