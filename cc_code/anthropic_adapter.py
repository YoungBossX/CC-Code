...
from cc_code.state import AppState, Store, add_cost, record_api_error, update_context_usage
...
def _get_retry_limit() -> int:
    try:
        value = int(float(os.environ.get("CC_CODE_MAX_RETRIES", DEFAULT_MAX_RETRIES)))
    except ValueError:
