...
from cc_code.config import get_mcp_config_path, load_scoped_mcp_servers, save_scoped_mcp_servers
from cc_code.skills import discover_skills, install_skill, remove_managed_skill


def _print_usage() -> None:
    print(
        "cc_code management commands\n\n"
        "cc_code mcp list [--project]\n"
        "cc_code mcp add <name> [--project] [--protocol <auto|content-length|newline-json>] [--env KEY=VALUE ...] -- <command> [args...]\n"
        "cc_code mcp remove <name> [--project]\n\n"
        "cc_code skills list\n"
        "cc_code skills add <path-to-skill-or-dir> [--name <name>] [--project]\n"
        "cc_code skills remove <name> [--project]\n\n"
        "cc_code valid-config"
    )
