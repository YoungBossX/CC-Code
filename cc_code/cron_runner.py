"""Scheduled headless task runner for CC-Coder.
...
def _default_config_path() -> Path:
    return Path(os.environ.get("CC_CODE_CRON_CONFIG", ".cc-code/cron.json"))
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Run CC-Coder scheduled headless tasks.")
