...
from cc_code.tui.navigation import _scroll_pending_approval_by, _toggle_pending_approval_expand, _move_pending_approval_selection, _scroll_transcript_by, _jump_transcript_to_edge, _history_up, _history_down, _get_visible_commands
from cc_code.tui.chrome import _cached_terminal_size
from cc_code.tui.tool_helpers import _summarize_tool_input, _is_file_edit_tool, _extract_path_from_tool_input, _summarize_collapsed_tool_body
from cc_code.tui.tool_lifecycle import _push_transcript_entry, _update_tool_entry, _update_transcript_entry, _append_to_transcript_entry, _collapse_tool_entry, _finalize_dangling_running_tools, _get_running_tool_entries, _schedule_tool_auto_collapse

logger = logging.getLogger("cc_code.input_handler")
...
class _RawModeContext:
    ...
    def __enter__(self) -> _RawModeContext:
        if sys.platform == "win32":
            ...
            from cc_code.tui.screen import _enable_windows_vt_processing
