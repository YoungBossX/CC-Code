# CC-Coder Advanced Improvement Plan

## Goal

Make CC-Coder feel closer to Claude Code in sustained coding sessions: reliable agent orchestration, responsive TUI, safe tools, strong context management, clean MCP integration, and measurable quality gates.
...
- Keep compatibility with the existing `cc-coder`, `cc-coder-headless`, `cc-coder-gateway`, and `cc-coder-cron` entry points.
...
2. Run `python -m compileall -q cc_code tests`.
...
Verification:
- `python -m compileall -q cc_code tests`
- `python -m pytest`
...
Risk:
- Permission persistence touches user-level files; tests should patch `CC_CODE_PERMISSIONS_PATH`.
...
Create:
- `cc_code/agent_events.py`
- `tests/test_agent_events.py`

Modify:
- `cc_code/agent_loop.py`
- `cc_code/tui/input_handler.py`
- `cc_code/headless.py`
...
- Manual mock run: `CC_CODE_MODEL_MODE=mock python -m cc_code.main`
...
Modify:
- `cc_code/tools/todo_write.py`
- `cc_code/task_tracker.py`
- `cc_code/tui/renderer.py`
- `cc_code/session.py`
...
Create:
- `cc_code/context_telemetry.py`
- `tests/test_context_telemetry.py`

Modify:
- `cc_code/agent_loop.py`
- `cc_code/tui/ui_hints.py`
...
- `cc_code/tooling.py`
- `cc_code/agent_loop.py`
- Tool modules under `cc_code/tools/`
...
Modify:
- `cc_code/tooling.py`
- `cc_code/tools/run_command.py`
- `cc_code/tools/write_file.py`
- `cc_code/tools/edit_file.py`
- `cc_code/tools/patch_file.py`
