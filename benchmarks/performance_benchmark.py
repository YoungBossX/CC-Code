"""Performance benchmark suite for CC-Coder.
...
# Add parent directory to path to import cc_code
import sys
sys.path.insert(0, str(Path(__file__).parent.parent))

from cc_code.context_manager import estimate_tokens, estimate_message_tokens
...
from cc_code.tooling import ToolContext, ToolRegistry
...
def run_all_benchmarks() -> list[BenchmarkResult]:
    ...
    print("=" * 80)
    print("CC-Coder Performance Benchmark")
    print("=" * 80)
    print()
...
if __name__ == "__main__":
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write("CC-Coder Benchmark Results\n")
        f.write("=" * 80 + "\n\n")
        for r in results:
